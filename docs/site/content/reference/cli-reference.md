...
guest, writes the [output envelope](/getting_started/getting-started#4-bring-a-vm-up-and-run-your-first-assertion)
...
[Parameters catalog](/reference/parameters). The most commonly used from the CLI:
